...
function Signup() {
  ...
  async function handleSubmit(e) {
    ...
    setLoading(true);
    try {
      await axios.post("/authuser/signup", formData);
      setSuccess(true);
      gsap.fromTo(
        cardRef.current,
        { scale: 0.98 },
  ...
  return (
    <div style={styles.wrapper}>
      ...
      <div ref={cardRef} style={styles.card}>
        ...
        <p style={styles.subtitle}>Start managing your tasks in seconds</p>
        ...
        <p style={styles.bottomText}>
          Want your hotel to be on our page?{" "}
          <Link to="/hotelAdminForm" style={styles.link}>
            Fill this form
          </Link>
        </p>
      </div>
